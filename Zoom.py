...
local_ip_address = socket.gethostbyname(socket.gethostbyname())

server = StreamingServer(local_ip_address, 9999)
receiver = AudoReceriver(local_ip_address, 8888)
...
def start_screen_sharing():
    screen_sharing = ScreenSharingClient(
        text_target_ip.get(1.0, "end-1c"), 7777)
...
windew = tk.Tk()
windew.title("MajedBabelli v0.0.1 ")
windew.geometry("300x200")
...
btn_camera = tk.Button(window, text="Start Camera Steam",
